...
public class Hospital extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //Call button
            Button hospital_call = (Button) rootView.findViewById(R.id.hospital_call);
            ...
            //Map button
            Button hospital_map = (Button) rootView.findViewById(R.id.hospital_map);
            ...
            //Message button
            Button hospital_message = (Button) rootView.findViewById(R.id.hospital_message);
            hospital_message.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        String numbers = numberOne+';'+numberTwo+';'+numberThree;
