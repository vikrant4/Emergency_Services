...
public class Fire extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //Call button
            Button fire_call = (Button) rootView.findViewById(R.id.fire_call);
            ...
            //Map button
            Button fire_map = (Button) rootView.findViewById(R.id.fire_map);
            fire_map.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            //Message button
            Button fire_message = (Button) rootView.findViewById(R.id.fire_message);
            fire_message.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        String numbers = numberOne + ';' + numberTwo + ';' + numberThree;
